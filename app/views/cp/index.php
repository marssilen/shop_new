...
<div class="w3-white" style="padding-bottom:0;padding-left:10px;padding-right:10px;">
<img src="<?= URL ?>public/<?php if($card['card_image']!=''){echo 'upload/'.$card['card_image'];}else{echo "image.png";}?>" style="width:100%;height: 150px;">
<p align="right" class="font" style="padding:0">

</p>
<a class="btn btn-info" href="<?= URL ?>cp/delete_item/<?=$card['id'] ?>">حذف</a>
<a class="btn btn-success" href="<?= URL ?>edit_item/index/<?=$card['id'] ?>">ویرایش</a>
</div>
</div>
</div>
    <?php }?>
